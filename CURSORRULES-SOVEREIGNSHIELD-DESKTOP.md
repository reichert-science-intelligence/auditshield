# CURSORRULES — SovereignShield Desktop

Source for `.cursorrules` install into `sovereignshield` (Desktop) repo.  
GitHub: reichert-science-intelligence/sovereignshield
