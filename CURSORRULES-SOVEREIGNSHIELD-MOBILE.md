# CURSORRULES — SovereignShield Mobile

Source for `.cursorrules` install into `sovereignshield-mobile` repo (when created).  
GitHub: reichert-science-intelligence/sovereignshield-mobile
